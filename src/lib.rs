...
use providers::{
    ...
    cloudflare::CloudflareProvider, desec::DesecProvider, digitalocean::DigitalOceanProvider,
    dnsimple::DNSimpleProvider, mailinabox::MailinaboxProvider, pdns::PdnsProvider,
